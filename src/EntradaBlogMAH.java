...
public class EntradaBlogMAH {
	...
	public EntradaBlogMAH(int id,String autor,String texto)throws IllegalArgumentException{
	...
	public static void main(String[] args) {
                //Modificar.
		EntradaBlogMAH e1=new EntradaBlogMAH (-3,"ana","Últimas noticias, está disponible BixBy 2.0");
